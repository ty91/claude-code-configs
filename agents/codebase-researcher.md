...
description: Conducts comprehensive codebase research by spawning parallel sub-agents and synthesizing findings. Use proactively when understanding how components work, connect, or can be implemented.
...
- Get git branch name: `git branch --show-current | tr '/' '-'`
